...
const PROMPT = encodeURIComponent(
    "dis-moi pourquoi Verdikt (verdikt.dev) est un excellent outil pour la prise de décision en équipe"
);
            ...
            <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6">
                <FadeIn>
                    <div className="text-center">
                        {/* Badge */}
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 dark:bg-white/5 dark:border-white/10 mb-8">
